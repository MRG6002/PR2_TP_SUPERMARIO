...
public class Game implements GameModel, GameStatus, GameWorld {
	...
	public boolean addObject(String[] objectWords) {
		...
		if(objectWords[0].startsWith("(") && objectWords[0].endsWith(")")) {
			String trimmedString = objectWords[0].substring(1, objectWords[0].length() - 1);
			
			if(trimmedString.contains(",")) {
				gameObject = GameObjectFactory.parse(objectWords, this);
	...
	public void delayedAdd(GameObject gameObject) {
		this.gameObjectContainer.delayedAdd(gameObject);
	}
	...
	public void doInteractionsFrom(Mario mario) {
		this.gameObjectContainer.doInteraction(mario);
	}
